...
@export var button_press_sound_effect: AudioStreamMP3 = preload("res://assets/audio/equip.mp3")
var button_press_audio_player: AudioStreamPlayer3D

## Sound effect to play when the correct code is entered
@export var correct_code_sound_effect: AudioStreamMP3 = preload("res://assets/audio/equip.mp3")
var correct_code_audio_player: AudioStreamPlayer3D

## Sound effect to play when the wrong code is entered
@export var wrong_code_sound_effect: AudioStreamMP3 = preload("res://assets/audio/equip.mp3")
